...
from synthgenie.synthesizers.digitone.agents.sound_design_agent import run_digitone_sound_design_agent
from synthgenie.synthesizers.shared.agents.validation_agent import prompt_validation_agent


async def run_digitone_agent_workflow(user_prompt: str, api_key: str, conn: psycopg2.extensions.connection):
    """
    ...
    return await run_digitone_sound_design_agent(user_prompt, api_key, conn)
