...
def set_lfo3_speed(
    ...
    return ctx.deps.lfo3_synth_controller.get_direct_parameter(
        "SPD", value, midi_channel
    )


def set_lfo3_multiplier(
    ctx: RunContext[SynthControllerDeps], value: int, midi_channel: int
) -> bool:
