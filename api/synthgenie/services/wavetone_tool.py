...
def set_osc1_pitch(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc1_waveform(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc1_phase_distortion(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the phase distortion of oscillator one."""
    return wavetone_synth_controller.set_parameter("page_1", "PD1", value, midi_channel)


def set_osc1_level(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc1_offset(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc1_table(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc2_pitch(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc2_waveform(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc2_phase_distortion(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the phase distortion of oscillator two."""
    return wavetone_synth_controller.set_parameter("page_1", "PD2", value, midi_channel)


def set_osc2_level(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc2_offset(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_osc2_table(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
# Modulation methods
def set_mod_type(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the modulation type."""
    return wavetone_synth_controller.set_parameter("page_2", "MOD", value, midi_channel)


def set_reset_mode(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the reset mode."""
    return wavetone_synth_controller.set_parameter(
...
def set_drift(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
# Envelope methods
def set_attack(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the attack time."""
    return wavetone_synth_controller.set_parameter("page_3", "ATK", value, midi_channel)


def set_hold(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the hold time."""
    return wavetone_synth_controller.set_parameter(
...
def set_decay(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the decay time."""
    return wavetone_synth_controller.set_parameter("page_3", "DEC", value, midi_channel)


def set_noise_level(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the noise level."""
    return wavetone_synth_controller.set_parameter(
...
# Noise methods
def set_noise_base(value: int, midi_channel: int) -> Tuple[int, int, int]:
...
def set_noise_width(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the noise width."""
    return wavetone_synth_controller.set_parameter(
...
def set_noise_type(value: int, midi_channel: int) -> Tuple[int, int, int]:
    """Set the noise type."""
    return wavetone_synth_controller.set_parameter(
...
def set_noise_character(value: int, midi_channel: int) -> Tuple[int, int, int]:
