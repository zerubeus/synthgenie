...
export const DIGITONE_PARAMS: Record<string, ParamSet> = {
  ...
  'WAVETONE_Page1': {
    ...
    'WAV1': { cc_msb: 41, nrpn_msb: 1, nrpn_lsb: 74, min_val: 0, max_val: 120, default: 0 },
    'PD1': { cc_msb: 42, nrpn_msb: 1, nrpn_lsb: 75, min_val: 0, max_val: 100, default: 50 },
    'LEV1': { cc_msb: 43, nrpn_msb: 1, nrpn_lsb: 76, min_val: 0, max_val: 127, default: 100 },
    'TUN2': { cc_msb: 44, nrpn_msb: 1, nrpn_lsb: 77, min_midi: 0, max_midi: 16383, min_val: -5.00, max_val: 5.00, default: 0.00 },
    'WAV2': { cc_msb: 45, nrpn_msb: 1, nrpn_lsb: 78, min_val: 0, max_val: 120, default: 0 },
    'PD2': { cc_msb: 46, nrpn_msb: 1, nrpn_lsb: 79, min_val: 0, max_val: 100, default: 50 },
    'LEV2': { cc_msb: 47, nrpn_msb: 1, nrpn_lsb: 80, min_val: 0, max_val: 127, default: 100 },
  },
  'WAVETONE_Page2': {
    'OFS1': { cc_msb: 48, nrpn_msb: 1, nrpn_lsb: 81, min_midi: 0, max_midi: 16383, min_val: -10.00, max_val: 10.00, default: 0.00 },
    'TBL1': { cc_msb: 49, nrpn_msb: 1, nrpn_lsb: 82, max_midi: 1, options: ['prim', 'harm'], default: 'prim' },
    'MOD': { cc_msb: 50, nrpn_msb: 1, nrpn_lsb: 83, max_midi: 3, options: ['off', 'ring mod', 'ring mod fixed', 'hard sync'], default: 'off' },
    'RSET': { cc_msb: 51, nrpn_msb: 1, nrpn_lsb: 84, max_midi: 2, options: ['off', 'on', 'random'], default: 'on' },
    'OFS2': { cc_msb: 52, nrpn_msb: 1, nrpn_lsb: 85, min_midi: 0, max_midi: 16383, min_val: -10.00, max_val: 10.00, default: 0.00 },
    'TBL2': { cc_msb: 53, nrpn_msb: 1, nrpn_lsb: 86, max_midi: 1, options: ['prim', 'harm'], default: 'prim' },
    'DRIF': { cc_msb: 55, nrpn_msb: 1, nrpn_lsb: 88, default: 0 },
  },
  'WAVETONE_Page3': {
    'ATK': { cc_msb: 56, nrpn_msb: 1, nrpn_lsb: 89, default: 0 },
    'HOLD': { cc_msb: 57, nrpn_msb: 1, nrpn_lsb: 90, default: 127 },
    'DEC': { cc_msb: 58, nrpn_msb: 1, nrpn_lsb: 91, default: 127 },
    'NLEV': { cc_msb: 59, nrpn_msb: 1, nrpn_lsb: 92, default: 0 },
    'BASE': { cc_msb: 60, nrpn_msb: 1, nrpn_lsb: 93, default: 0 },
    'WDTH': { cc_msb: 61, nrpn_msb: 1, nrpn_lsb: 94, default: 127 },
    'TYPE': { cc_msb: 62, nrpn_msb: 1, nrpn_lsb: 95, max_midi: 2, options: ['grain nose', 'tuned noise', 'sample and hold noise'], default: 0 },
    'CHAR': { cc_msb: 63, nrpn_msb: 1, nrpn_lsb: 96, default: 0 },
  },
  ...
  'FM_DRUM_Page2': {
    'RATIO1': { cc_msb: 48, nrpn_msb: 1, nrpn_lsb: 81, min_midi: 0, max_midi: 16383, min_val: 0.001, max_val: 31.75, default: 0.500 },
    'DEC1': { cc_msb: 49, nrpn_msb: 1, nrpn_lsb: 82, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
    'END1': { cc_msb: 50, nrpn_msb: 1, nrpn_lsb: 83, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
    'MOD1': { cc_msb: 51, nrpn_lsb: 1, nrpn_msb: 84 },
    'RATIO2': { cc_msb: 52, nrpn_msb: 1, nrpn_lsb: 85, min_midi: 0, max_midi: 16383, min_val: 0.001, max_val: 31.75, default: 0.500 },
    'DEC2': { cc_msb: 53, nrpn_msb: 1, nrpn_lsb: 86, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
    'END2': { cc_msb: 54, nrpn_msb: 1, nrpn_lsb: 87, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
    'MOD2': { cc_msb: 55, nrpn_lsb: 1, nrpn_msb: 88 },
  },
  'FM_DRUM_Page3': {
    'HOLD': { cc_msb: 56, nrpn_msb: 1, nrpn_lsb: 89, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
    'DEC': { cc_msb: 57, nrpn_msb: 1, nrpn_lsb: 90, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
  ...
  'FM_DRUM_Page4': {
    'NHLD': { cc_msb: 70, nrpn_msb: 1, nrpn_lsb: 97, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
    'NDEC': { cc_msb: 71, nrpn_msb: 1, nrpn_lsb: 98, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 127, default: 0 },
    'TRAN': { cc_msb: 72, nrpn_msb: 1, nrpn_lsb: 99, min_midi: 0, max_midi: 16383, min_val: 0, max_val: 124, default: 0 },
